...
# Contributing to TitanicPrediction

We appreciate your interest in contributing to TitanicPrediction! Please review these guidelines before submitting contributions.
...
### Running Tests
```bash
pytest --cov=TitanicPrediction --cov-report=term-missing
```

### Code Quality Checks
```bash
ruff check src/titanicprediction
flake8 src/titanicprediction
```
